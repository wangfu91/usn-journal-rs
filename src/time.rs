...
mod tests {
    ...
    mod basic_conversion_tests {
        ...
        fn test_zero_filetime() {
            ...
            let result = filetime_to_systemtime(0);
    ...
    mod edge_case_tests {
        ...
        fn test_large_filetime_values() {
            ...
            let result = filetime_to_systemtime(large_filetime);
        ...
        fn test_negative_filetime_values() {
            // Test with small negative FILETIME (slightly before Windows epoch)
            let negative_filetime = -10_000_000; // 1 second before Windows epoch
            match std::panic::catch_unwind(|| filetime_to_systemtime(negative_filetime)) {
                Ok(result) => {
                    // If it doesn't panic, it should produce a time before Windows epoch
                    let windows_epoch_systemtime: SystemTime = WINDOWS_EPOCH_UTC.into();
                    assert!(result < windows_epoch_systemtime);
                }
                Err(_) => {
                    // Panicking is acceptable for extreme negative values
                }
            }
        }
        ...
        fn test_nanosecond_precision() {
            ...
            let result = filetime_to_systemtime(one_second_later);
            ...
            let result_ms = filetime_to_systemtime(one_ms_later);
        ...
        fn test_filetime_as_unsigned() {
            ...
            let result = filetime_to_systemtime(large_value);
    ...
    mod consistency_tests {
        ...
        fn test_conversion_consistency() {
            ...
            for filetime in test_values {
                let system_time = filetime_to_systemtime(filetime);
        ...
        fn test_multiple_calls_consistency() {
            ...
            let result1 = filetime_to_systemtime(test_filetime);
            let result2 = filetime_to_systemtime(test_filetime);
    ...
    mod integration_tests {
        ...
        fn test_current_time_conversion() -> windows::core::Result<()> {
            ...
            let filetime_i64 = ((ft.dwHighDateTime as i64) << 32) | (ft.dwLowDateTime as i64);
            let converted = filetime_to_systemtime(filetime_i64);
